...
class AttributeLevelObj():
    ...
    def __init__(self, attribute, level, proteomes):
        ...
        self.level = level # str
        self.proteomes = proteomes # set()
        self.proteome_count = len(proteomes) # int

        self.proteins = [] # all proteins of this ALO

        self.clusters_by_cluster_type = {'singleton': [], 'gained' : [], 'shared' : [], 'lost' : []}
        self.proteins_by_cluster_type = {'singleton': [], 'gained' : [], 'shared' : [], 'lost' : []}

        self.clusters_by_cardinality = {'gained' : {'true_1_to_1' : [], 'fuzzy_1to1' : []}, 'shared' : {'true_1_to_1' : [], 'fuzzy_1to1' : [], 'below' : [], 'above': []}
