...
usage: get_count_matrix.py           -g <FILE> -s <FILE> -c <FILE> [-u <FILE>] [-t <FILE>] [-i <FILE>]
    ...
    Options:
        ...
        -t, --target_ids <FILE>                 List of protein/gene ids (one protein ID per line; protein_id,name,description)
        -f, --functional_annotation <FILE>      cluster_functional_annotation.all.*.txt (generated by filter_functional_annotation_of_clusters.py)
